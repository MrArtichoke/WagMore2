...
db.forum_post.user_id.readable = db.forum_post.votes.writable = False
db.forum_post.created_on.writable = False
db.forum_post.updated_on.writable = False
...
db.comm.author.requires = IS_NOT_EMPTY()
